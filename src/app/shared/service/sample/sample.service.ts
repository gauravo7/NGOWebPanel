...
import { BASE_URL, ALL_SAMPLES, ADD_SAMPLE, SINGLE_SAMPLE, UPDATE_SAMPLE, ENABLE_DISABLE_SAMPLE, GET_CITIES, GET_STATES, ALL_ISSUED_SAMPLE, ISSUED_SAMPLE_ADD, ALL_ISSUED_SAMPLE_DISTRIBUTOR, ALL_ISSUED_SAMPLE_TO_CUSTOMER, SELECT_SINGLE_SAMPLE_FOR_ISSUE, ISSUED_MULTIPLE_SAMPLE_TO_DIS, CHECK_MULTIPLE_SAMPLE_BEFORE_ISSUE, ALL_ISSUED_SAMPLE_DISTRIBUTOR_TRANSACTION, ADD_TREATMENT, ADD_CATEGORY_LOGS, ADD_WARD_LOGS, ADD_DISCHARGE, ALL_WARD_LOGS, ALL_CATEGORY_LOGS, ALL_TREATMENT, BULK_ADD_PEOPLE } from 'src/app/endpoints';
